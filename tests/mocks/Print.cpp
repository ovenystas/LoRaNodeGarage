...
size_t Print::print(short int n, int base) {
...
size_t Print::print(short unsigned int n, int base) {
...
size_t Print::println(short int num, int base) {
...
size_t Print::println(short unsigned int num, int base) {
  size_t n = print(num, base);
  n += println();
  return n;
}
