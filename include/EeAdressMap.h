...
#define EE_ADDRESS_CONFIG_DISTANCE_SENSOR_1 \
  (EE_ADDRESS_CONFIG_DISTANCE_SENSOR_0 + EE_ADDRESS_ITEM_SIZE)
#define EE_ADDRESS_CONFIG_DISTANCE_SENSOR_2 \
  (EE_ADDRESS_CONFIG_DISTANCE_SENSOR_1 + EE_ADDRESS_ITEM_SIZE)
#define EE_ADDRESS_CONFIG_DISTANCE_SENSOR_3 \
  (EE_ADDRESS_CONFIG_DISTANCE_SENSOR_2 + EE_ADDRESS_ITEM_SIZE)
...
#define EE_ADDRESS_CONFIG_HEIGHT_SENSOR_2 \
  (EE_ADDRESS_CONFIG_HEIGHT_SENSOR_1 + EE_ADDRESS_ITEM_SIZE)
#define EE_ADDRESS_CONFIG_HEIGHT_SENSOR_3 \
  (EE_ADDRESS_CONFIG_HEIGHT_SENSOR_2 + EE_ADDRESS_ITEM_SIZE)
...
#define EE_ADDRESS_CONFIG_HUMIDITY_SENSOR_1 \
  (EE_ADDRESS_CONFIG_HUMIDITY_SENSOR_0 + EE_ADDRESS_ITEM_SIZE)
#define EE_ADDRESS_CONFIG_HUMIDITY_SENSOR_2 \
  (EE_ADDRESS_CONFIG_HUMIDITY_SENSOR_1 + EE_ADDRESS_ITEM_SIZE)
#define EE_ADDRESS_CONFIG_HUMIDITY_SENSOR_3 \
  (EE_ADDRESS_CONFIG_HUMIDITY_SENSOR_2 + EE_ADDRESS_ITEM_SIZE)
...
#define EE_ADDRESS_CONFIG_PRESENCE_BINARY_SENSOR_3 \
  (EE_ADDRESS_CONFIG_PRESENCE_BINARY_SENSOR_2 + EE_ADDRESS_ITEM_SIZE)
...
#define EE_ADDRESS_CONFIG_TEMPERATURE_SENSOR_1 \
  (EE_ADDRESS_CONFIG_TEMPERATURE_SENSOR_0 + EE_ADDRESS_ITEM_SIZE)
#define EE_ADDRESS_CONFIG_TEMPERATURE_SENSOR_2 \
  (EE_ADDRESS_CONFIG_TEMPERATURE_SENSOR_1 + EE_ADDRESS_ITEM_SIZE)
#define EE_ADDRESS_CONFIG_TEMPERATURE_SENSOR_3 \
  (EE_ADDRESS_CONFIG_TEMPERATURE_SENSOR_2 + EE_ADDRESS_ITEM_SIZE)
